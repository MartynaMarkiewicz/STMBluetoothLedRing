...
//	delay_ms(150);
	...
	delay_ms(50);
	/////////////
	diode[0].red=0;   diode[0].green=0;   diode[0].blue=139;
//	delay_ms(150);
...
//	delay_ms(150);
	diode[4].red=255; diode[4].green=69;  diode[4].blue=0; //orange
//	delay_ms(150);
...
//	delay_ms(150);
	diode[1].red=0;   diode[1].green=0;   diode[1].blue=139;
//	delay_ms(150);
...
//	delay_ms(150);
	diode[5].red=255; diode[5].green=69;  diode[5].blue=0; //orange
//	delay_ms(150);
...
//	delay_ms(150);
	diode[2].red=0;   diode[2].green=0;   diode[2].blue=139;
//	delay_ms(150);
...
//	delay_ms(150);
	diode[6].red=255; diode[6].green=69;  diode[6].blue=0; //orange
//	delay_ms(150);
...
//	delay_ms(150);
	diode[3].red=0;   diode[3].green=0;   diode[3].blue=139;
//	delay_ms(150);
...
//	delay_ms(150);
	diode[7].red=255; diode[7].green=69;  diode[7].blue=0; //orange
	delay_ms(50);
	///////////////
	diode[0].red=255; diode[0].green=69;  diode[0].blue=0; //orange
//	delay_ms(150);
...
//	delay_ms(150);
	diode[4].red=0;   diode[4].green=0;   diode[4].blue=139;
//	delay_ms(150);
...
//	delay_ms(150);
	diode[1].red=255; diode[1].green=69;  diode[1].blue=0; //orange
//	delay_ms(150);
...
//	delay_ms(150);
	diode[5].red=0;   diode[5].green=0;   diode[5].blue=139;
//	delay_ms(150);
...
//	delay_ms(150);
	diode[2].red=255; diode[2].green=69;  diode[2].blue=0; //orange
//	delay_ms(150);
...
//	delay_ms(150);
	diode[6].red=0;   diode[6].green=0;   diode[6].blue=139;
//	delay_ms(150);
...
for(i=0;i<8;i++)
{
	diode[i].red=255; diode[i].green=255; diode[i].blue=225;
	diode[i].red=255; diode[i].green=0;	  diode[i].blue=225;
	diode[i].red=255; diode[i].green=69;  diode[i].blue=0; //orange}
	diode[i].red=255; diode[i].green=255; diode[i].blue=0;
	diode[i].red=0;   diode[i].green=255; diode[i].blue=0;
	diode[i].red=0;   diode[i].green=0;   diode[i].blue=225;
	diode[i].red=0;   diode[i].green=0;   diode[i].blue=139;
}
}
